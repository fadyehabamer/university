...
namespace Library.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
      ...
      : base(options)
        ...
        public DbSet<Library.ViewModels.ApplicationUserVM> ApplicationUserVM { get; set; } = default!;
        public DbSet<Library.ViewModels.LoginUserVM> LoginUserVM { get; set; } = default!;
        public DbSet<Library.ViewModels.RolesVM> RolesVM { get; set; } = default!;
